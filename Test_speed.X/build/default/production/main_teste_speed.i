...
void main(void) {
    ...
    while (1) {
        ...
        temp_mC = voltage_mV1 * 100;


        char sign_v = (voltage_mV1 < 0) ? '-' : ' ';
        int16_t abs_v = (voltage_mV1 < 0) ? -voltage_mV1 : voltage_mV1;
        ...
        sprintf(str_buffer, "%c%d", sign_t, abs_t / 10);
        ...
        if (newMeasure) {
            ...
            if (period > 0) {
                ...
                uint32_t freqRot = freq/48 ;

                uint32_t vitess = freqRot*6.785840138;
